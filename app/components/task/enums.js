...
export const taskTypes= [
    ...
    {label:'Баг', value:'BUG'},
    {label:'Косметические исправления', value:'COSMETICS'},
    {label:'Не требует исправления', value:'WONTFIX'},
    {label:'Предложение', value:'ASSUMPTION'},
];