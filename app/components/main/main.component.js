...
class MainComponent extends Component {
    ...
    navigateToSearch(searchString){
        ...
        this.navigator && this.navigator.dispatch({ type: 'Navigation/NAVIGATE', routeName: 'Search', params: {searchString} });
    }
    ...
    render() {
        const menu = <Menu isOpen={this.state.isOpen} navigateToDashboard={this.navigateToDashboard.bind(this)} navigateToSearch={this.navigateToSearch.bind(this)}
